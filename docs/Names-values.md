...
```r
ref(l1, l2)
#> █ [1:0x5618b2dcd4c8] <list> 
#> ├─[2:0x5618b230be78] <dbl> 
#> ├─[3:0x5618b230bf20] <dbl> 
#> └─[4:0x5618b22f7260] <dbl> 
#>  
#> █ [5:0x5618b7918e78] <list> 
#> ├─[2:0x5618b230be78] 
#> ├─[3:0x5618b230bf20] 
#> └─[6:0x5618b6d1e8e0] <dbl>
```
...
#> █ [1:0x5618b752bb78] <chr> 
#> ├─[2:0x5618b064f348] <string: "a"> 
#> ├─[2:0x5618b064f348] 
#> ├─[3:0x5618b73ad858] <string: "abc"> 
#> └─[4:0x5618b0804c68] <string: "d">
```
...
ref(e)
#> █ [1:0x5618bb321160] <env> 
#> └─self = [1:0x5618bb321160]
```
...
#> Ncells  834323 44.6    1627408   87  1612586  86.2
#> Vcells 4939247 37.7   16956964  129 16760525 127.9
```
