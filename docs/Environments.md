...
```r
env_parents(e2b)
#> [[1]]   <env: 0x55c94831bea8>
#> [[2]] $ <env: global>
env_parents(e2d)
#> [[1]]   <env: 0x55c94b7cba10>
#> [[2]] $ <env: empty>
```
