...
add
#> function (x, y, z) 
#> .Call(<pointer: 0x7f2d46879480>, x, y, z)
add(1, 2, 3)
#> [1] 6
```
...
#> 1 sum(x)        1.1µs    1.2µs   715012.        0B     0   
#> 2 sumC(x)       3.1µs    5.3µs   205507.    2.49KB     0   
#> 3 sumR(x)        35µs   35.4µs    28006.  182.89KB     2.80
```
...
#>   expression          min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr>     <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 pdistR(0.5, y)   6.33ms   6.76ms      146.    7.63MB     74.8
#> 2 pdistC(0.5, y)    8.9ms   8.98ms      111.    7.63MB     69.8
```
...
#>   expression              min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr>         <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 gibbs_r(100, 10)     5.58ms   5.72ms      169.    4.97MB     29.0
#> 2 gibbs_cpp(100, 10) 286.51µs 314.41µs     3145.     4.1KB     19.4
```
...
#>   expression      min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 vacc1        1.94ms   2.12ms      471.    7.86KB     25.4
#> 2 vacc2          67µs   72.7µs    13190.  148.85KB     30.0
#> 3 vacc3        24.8µs   26.3µs    37841.   14.48KB     11.4
```
